...
public class DosUsuarios_EJ4_JoseASanchezLopez extends Thread{
    @Override
    public void run() {
...
class EjecutandoUsuarios{
    public static void main(String[] args) throws InterruptedException {
        Thread usuario1=new Thread(new DosUsuarios_EJ4_JoseASanchezLopez());
        Thread usuario2=new Thread(new DosUsuarios_EJ4_JoseASanchezLopez());
